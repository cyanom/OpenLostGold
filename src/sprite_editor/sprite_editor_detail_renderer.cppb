...
using SpriteBox = uengine::graphics::SpriteBox;
namespace gh = uengine::graphics::helper;


SpriteEditorDetailRenderer::SpriteEditorDetailRenderer(GraphicsBase * gb_) {
    gb = gb_;
...
SpriteEditorDetailRenderer::~SpriteEditorDetailRenderer() {
    destroyOffscreen();
    destroyGrid();
    destroySpriteBox();
    delete spriteBox;
...
void SpriteEditorDetailRenderer::setBackgroundColor(float color[4]) {
    std::copy(color, color + 4, backgroundColor);
}

void SpriteEditorDetailRenderer::setVP(glm::mat4 vp_) {
    vp = vp_;
    tileset.changed = true;
    sprite.changed = true;
}

void SpriteEditorDetailRenderer::setGridModel(glm::mat4 model) {
    grid.model = model;
    grid.changed = true;
}

void SpriteEditorDetailRenderer::setGridColor(float color1[4], float color2[4]) {
    grid.gridParamData.color1 = glm::make_vec4(color1);
    grid.gridParamData.color2 = glm::make_vec4(color2);
    grid.changed = true;
}

void SpriteEditorDetailRenderer::setGridViewSize(int viewSize[2]) {
    grid.gridParamData.viewSize = glm::make_vec2(viewSize);
    grid.changed = true;
}

void SpriteEditorDetailRenderer::setGridPixelSize(float pixelSize[2]) {
    grid.gridParamData.pixelSize = glm::make_vec2(pixelSize);
    grid.changed = true;
}

void SpriteEditorDetailRenderer::setGridOffset(float offset[2]) {
    grid.gridParamData.offset = glm::make_vec2(offset);
    grid.changed = true;
}

void SpriteEditorDetailRenderer::setGridExtended(bool extended) {
    grid.gridParamData.extended = extended;
    grid.changed = true;
}


void SpriteEditorDetailRenderer::setBoxModel(glm::mat4 model) {
    box.boxData.model = model;
    box.changed = true;
}

void SpriteEditorDetailRenderer::setBoxColor(float color[4]) {
    box.boxData.color = glm::make_vec4(color);
    box.changed = true;
}

void SpriteEditorDetailRenderer::setSprite(Sprite * sprite) {
    if (spriteBoxData.spriteBox)
        delete spriteBoxData.spriteBox;
    spriteBoxData.spriteBox = SpriteBox(sprite);
    spriteBoxData.changed = true;
}

SpriteBox * SpriteEditorDetailRenderer::getSpriteBox() {
    return spriteBoxData.spriteBox;
}

void SpriteEditorDetailRenderer::update() {
    if (box.changed) {
        updateBoxBuffers();
    ...
    if (spriteBoxData.changed) {
        updateSpriteBoxBuffers();
        spriteBoxData.changed = false;
    }
}

void SpriteEditorDetailRenderer::render(VkCommandBuffer cb) {
    ...
    if (spriteBoxData.spriteBox && !spriteBoxData.changed) {
        vkCmdBindPipeline(cb, VK_PIPELINE_BIND_POINT_GRAPHICS, spriteBoxData.pipeline);
        vkCmdBindDescriptorSets(cb, VK_PIPELINE_BIND_POINT_GRAPHICS, spriteBoxData.pipelineLayout, 0, 1, &spriteBoxData.descriptorSet, 0, nullptr);
        vkCmdDraw(cb, 6, 1, 0, 0);
    }
...
void SpriteEditorDetailRenderer::resize(int32_t width, int32_t height) {
...
ImTextureID SpriteEditorDetailRenderer::getTexture() {
...
void SpriteEditorDetailRenderer::setupDescriptorPool() {
...
void SpriteEditorDetailRenderer::setupRenderPass() {
...
void SpriteEditorDetailRenderer::setupOffscreen(int32_t width, int32_t height) {
...
void SpriteEditorDetailRenderer::destroyOffscreen() {
...
void SpriteEditorDetailRenderer::setupGrid() {
    setupGridBuffers();
...
void SpriteEditorDetailRenderer::setupGridBuffers() {
...
void SpriteEditorDetailRenderer::setupGridDescriptorSetLayout() {
    // Binding
...
void SpriteEditorDetailRenderer::setupGridDescriptorSet() {
...
void SpriteEditorDetailRenderer::setupGridPipeline() {
    // Shaders
    VkShaderModule vertShaderModule = gb->createShaderModule("res/shaders/detail_renderer/grid/vert.spv");
    VkShaderModule fragShaderModule = gb->createShaderModule("res/shaders/detail_renderer/grid/frag.spv");
...
void SpriteEditorDetailRenderer::updateGridBuffers() {
    glm::mat4 m = vp * grid.model;
...
void SpriteEditorDetailRenderer::destroyGrid() {
...
void SpriteEditorDetailRenderer::setupSpriteBox() {
    setupSpriteBoxBuffers();
    setupSpriteBoxDescriptorSetLayout();
    setupSpriteBoxDescriptorSet();
    setupSpriteBoxPipeline();
}

void SpriteEditorDetailRenderer::setupSpriteBoxBuffers() {
...
void SpriteEditorDetailRenderer::setupSpriteBoxDescriptorSetLayout() {
    // Binding
    std::vector<VkDescriptorSetLayoutBinding> setLayoutBindings = {
        gh::descriptorSetLayoutBinding(
            VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
...
void SpriteEditorDetailRenderer::setupSpriteBoxDescriptorSet() {
    VkDescriptorSetAllocateInfo allocInfo =
        gh::descriptorSetAllocateInfo(
            descriptorPool,
...
void SpriteEditorDetailRenderer::setupSpriteBoxPipeline() {
    // Shaders
...
void SpriteEditorDetailRenderer::updateSpriteBoxBuffers() {
...
void SpriteEditorDetailRenderer::destroySpriteBox() {
...
GraphicsQuads * SpriteEditorDetailRenderer::getCurrentSelectionQuads() {
    return currentSelection.quads;
}

GraphicsQuads * SpriteEditorDetailRenderer::getPreviousSelectionQuads() {
